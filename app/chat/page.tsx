...
function ChatContent() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            // Merge current chat history with global history (avoid duplicates)
            ...
            // Show modern popup error message
            ...
            // Re-set input if it failed so user doesn't lose it
            setInput(userInput);
        } finally {
            setIsLoading(false);
        }
                ...
                <div className="container flex h-16 items-center justify-between px-4 sm:px-8">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <ProfileDropdown
                            ...
                            onLogout={() => { }} // Handle globally if needed
                            onEditProfile={() => { }} // Link back to home
                        />
                    </div>
                </div>
            </header>
